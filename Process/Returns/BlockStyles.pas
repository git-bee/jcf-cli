...
begin
  ...
  begin
    ...
    else if (lcNextToken.TokenType = ttBegin) or (lcNextToken.TokenType = ttTry) or
       (lcNextToken.TokenType = ttRepeat) or (lcNextToken.TokenType = ttCase) or
       (lcNextToken.TokenType = ttWhile) or (lcNextToken.TokenType = ttWith) or
       (lcNextToken.TokenType = ttIf) or (lcNextToken.TokenType = ttFor) then
    begin
  ...
  begin
    { otherwise, is there a begin next? }
    if (lcNextToken.TokenType = ttBegin) or (lcNextToken.TokenType = ttTry) or
       (lcNextToken.TokenType = ttRepeat) or (lcNextToken.TokenType = ttCase) or
       (lcNextToken.TokenType = ttWhile) or (lcNextToken.TokenType = ttWith) or
       (lcNextToken.TokenType = ttIf) or (lcNextToken.TokenType = ttFor) then
      Result := FormatSettings.Returns.BlockBeginStyle
